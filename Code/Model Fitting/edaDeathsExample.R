...
# alcoholPredictedHeatmap_rw1 <-
#   ggplot2::ggplot(alcoholResults %>% dplyr::filter(model == 'RW1'), aes(y = age, x = period, fill = yHat)) + 
#   ggplot2::scale_x_continuous(breaks = seq(2005, 2021, 1)) +
#   ggplot2::scale_y_continuous(breaks = seq(25, 85, 5)) +
#   ggplot2::geom_raster() +
#   ggplot2::scale_fill_viridis_c('Log rate', option = 'G', direction = 1) +
...
#   ggplot2::labs(x = 'Year', y = 'Age') +
#   my.theme(text = element_text(size = textSize),
#            axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1)); alcoholPredictedHeatmap_rw1
...
ggplot2::ggsave(filename = paste0(resultsDir, '/alcoholPredictedHeatmap_spline.png'),
                ...
                height = height, width = width)
# ggplot2::ggsave(filename = paste0(resultsDir, '/alcoholPredictedHeatmap_rw1.png'),
#                 plot = alcoholPredictedHeatmap_rw1,
#                 height = height, width = width)
...
# alcoholPredicted_RW2VsRW1 <-
#   ggplot2::ggplot(alcoholResults %>% 
#                     tidyr::pivot_wider(., names_from = model, values_from = c('yHat', 'lower', 'upper')),
#                   aes(x = yHat_RW2, y = yHat_RW1)) +
#   ggplot2::geom_abline(aes(intercept = 0, slope = 1), colour = 'red3', linetype = 'dotted', linewidth = 1) +
#   ggplot2::geom_point() +
#   ggplot2::labs(x = 'RW2', y = 'RW1') +
#   my.theme(); alcoholPredicted_RW2VsRW1


# ggplot2::ggsave(filename = paste0(resultsDir, '/alcoholPredicted_splineVsRW1.png'),
#                 plot = alcoholPredicted_splineVsRW1,
#                 height = height, width = width)
ggplot2::ggsave(filename = paste0(resultsDir, '/alcoholPredicted_splineVsRW2.png'),
                plot = alcoholPredicted_splineVsRW2,
                height = height, width = width)
# ggplot2::ggsave(filename = paste0(resultsDir, '/alcoholPredicted_RW2VsRW1.png'),
#                 plot = alcoholPredicted_RW2VsRW1,
#                 height = height, width = width)
...
# selfHarmPredictedHeatmap_rw1 <-
#   ggplot2::ggplot(selfHarmResults %>% dplyr::filter(model == 'RW1'), aes(y = age, x = period, fill = yHat)) + 
#   ggplot2::scale_x_continuous(breaks = seq(2005, 2021, 1)) +
#   ggplot2::scale_y_continuous(breaks = seq(25, 85, 5)) +
#   ggplot2::geom_raster() +
#   ggplot2::scale_fill_viridis_c('Log rate', option = 'G', direction = 1) +
...
#   ggplot2::labs(x = 'Year', y = 'Age') +
#   my.theme(text = element_text(size = textSize),
#            axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1)); selfHarmPredictedHeatmap_rw1
...
ggplot2::ggsave(filename = paste0(resultsDir, '/selfHarmPredictedHeatmap_spline.png'),
                ...
                height = height, width = width)
# ggplot2::ggsave(filename = paste0(resultsDir, '/selfHarmPredictedHeatmap_rw1.png'),
#                 plot = selfHarmPredictedHeatmap_rw1,
#                 height = height, width = width)
...
#   ggplot2::geom_point() +
#   ggplot2::labs(x = 'Spline', y = 'RW1') +
#   my.theme(); selfHarmPredicted_splineVsRW1
...
#   ggplot2::geom_point() +
#   ggplot2::labs(x = 'RW2', y = 'RW1') +
#   my.theme(); selfHarmPredicted_RW2VsRW1


# ggplot2::ggsave(filename = paste0(resultsDir, '/selfHarmPredicted_splineVsRW1.png'),
#                 plot = selfHarmPredicted_splineVsRW1,
#                 height = height, width = width)
ggplot2::ggsave(filename = paste0(resultsDir, '/selfHarmPredicted_splineVsRW2.png'),
                plot = selfHarmPredicted_splineVsRW2,
                height = height, width = width)
# ggplot2::ggsave(filename = paste0(resultsDir, '/selfHarmPredicted_RW2VsRW1.png'),
#                 plot = selfHarmPredicted_RW2VsRW1,
#                 height = height, width = width)
